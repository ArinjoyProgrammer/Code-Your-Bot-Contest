...
class Commands(commands.Cog):
    ...
    async def info(self, ctx):
        ...
        embed = discord.Embed(title="", description="Hello! I am **hyper** a **Multi-purpose** bot!", color=discord.Color.random())
        ...
        embed.add_field(name="Vote", value="[discord Bots List](https://discordbotlist.com/bots/hyper)", inline=True)
