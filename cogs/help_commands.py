...
class HelpCommand(commands.Cog):
    ...
    async def help(self, ctx):
        embed = discord.Embed(title="Help Command ||  hyper Bot", description="", timestamp=datetime.utcnow(), color=ctx.author.color)
    ...
    async def commands(self, ctx):
        ...
        embed = discord.Embed(title="Chat Commands Help  ||  hyper Bot", description="", timestamp=datetime.utcnow(), color=ctx.author.color)
    ...
    async def roles(self, ctx):
        ...
        embed = discord.Embed(title="Add Roles Commands Help  ||  hyper Bot", description="", timestamp=datetime.utcnow(), color=ctx.author.color)
    ...
    async def calculator(self, ctx):
        ...
        embed = discord.Embed(title="Calculator Commands Help  ||  hyper Bot", description="", timestamp=datetime.utcnow(), color=ctx.author.color)
    ...
    async def datetime(self, ctx):
        ...
        embed = discord.Embed(title="Datetime Command Help  ||  hyper Bot", description="", timestamp=datetime.utcnow(), color=ctx.author.color)
    ...
    async def images(self, ctx):
        ...
        embed = discord.Embed(title="Meme Command Help  ||  hyper Bot", decsription="", timestamp=datetime.utcnow(), color=ctx.author.color)
    ...
    async def games(self, ctx):
        embed = discord.Embed(title="Games Command Help  ||  hyper Bot", description="", timestamp=datetime.utcnow(), color=ctx.author.color)
    ...
    async def normiemsg(self, ctx):
        ...
        embed = discord.Embed(title="Normal Messages Help  ||  hyper Bot", description="", timestamp=datetime.utcnow(), color=ctx.author.color)
        embed.add_field(name="Normal Messages (Without Special Arguments) (Prefix Isn't Required)", value="```hyper```", inline=False)
        embed.set_footer(text=f"Command Requested by {ctx.author}")
    ...
    async def moderation(self, ctx):
        ...
        embed = discord.Embed(title="Moderation Commands Help  ||  hyper Bot", description="", timestamp=datetime.utcnow(), color=ctx.author.color)
    ...
    async def usercommands(self, ctx):
        embed = discord.Embed(title="User Commands Help  ||  hyper Bot", description="", timestamp=datetime.utcnow(), color=ctx.author.color)
    ...
    async def othermorecmds(self, ctx):
        embed = discord.Embed(title="Other More Commands Help  ||  hyper Bot", description="", timestamp=datetime.utcnow(), color=ctx.author.color)
